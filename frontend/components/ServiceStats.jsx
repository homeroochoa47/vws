...
export default function ServiceStats() {
  return (
    <div className="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12 p-8">
        ...
        <Link href="/contact" className="mt-2 md:mt-4 inline-block rounded-[15px] bg-dark-grey/60 px-12 py-3 text-lg text-lighter-grey shadow-sm transition duration-150 ease-in-out hover:bg-charcoal hover:shadow-xl md:mr-2 font-two"
            role="button">Get a Quote
        </Link>
        </div>
        ...
        <div className="lg:col-span-2">
            <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
                <div className="flex gap-x-5 bg-charcoal/5 p-2 rounded-lg">
                    <svg className="flex-shrink-0 mt-1 w-7 h-7 text-dark-grey dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
